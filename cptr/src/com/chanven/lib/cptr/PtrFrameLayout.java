...
public class PtrFrameLayout extends ViewGroup {
    ...
    //
    private boolean needPullToFresh = true;
    private boolean needLoadMore = true;

    public void setNeedPullToFresh(boolean needPullToFresh) {
        this.needPullToFresh = needPullToFresh;
    }
...
//                PtrCLog.v(LOG_TAG, "needPullToFresh:" + needPullToFresh + "---needLoadMore:" + needLoadMore + "---offsetY:" + offsetY);
                if ((moveUp && canMoveUp) || moveDown) {
                    if ((needPullToFresh && offsetY > 0) || (needLoadMore && offsetY < 0)) {
                        movePos(offsetY);
                    }
                    return true;
                }
    ...
    public void setFooterView(ILoadMoreViewFactory factory) {
        PtrCLog.e(LOG_TAG, "----setFooterView---hasInitLoadMoreView:" + hasInitLoadMoreView);
